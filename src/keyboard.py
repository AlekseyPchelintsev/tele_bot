...
about_me = InlineKeyboardMarkup(inline_keyboard=[
  [InlineKeyboardButton(text='🎸 Редактировать "Увлечения"', callback_data='edit_hobbies')],
...
edit_hobbies = InlineKeyboardMarkup(inline_keyboard=[
  [InlineKeyboardButton(text='📥 Добавить увлечение', callback_data='new_hobbie')],
  [InlineKeyboardButton(text='🚮 Удалить увлечение', callback_data='del_hobbie')],
...
edit_photo = InlineKeyboardMarkup(inline_keyboard=[
  [InlineKeyboardButton(text='📸 Загрузить новое фото', callback_data='new_photo')],
...
start_edit = InlineKeyboardMarkup(inline_keyboard=[
  [InlineKeyboardButton(text='🎸 Редактировать "Увлечения"', callback_data='my_profile')],
...
users_menu = InlineKeyboardMarkup(inline_keyboard=[
  ...
  [InlineKeyboardButton(text='🔍 Поиск по увлеченям', callback_data='search_users')],
  [InlineKeyboardButton(text='↩️ Вернуться назад', callback_data='main_menu')]])
...
def paginator(page: int=0, list_type: str= 'default'):
  ...
  builder.row(
    InlineKeyboardButton(text='◀️',callback_data=Pagination(action='prev', page=page, list_type=list_type).pack()),
    InlineKeyboardButton(text='↩️ Назад',callback_data=Pagination(action='menu', page=page, list_type=list_type).pack()),
    InlineKeyboardButton(text='▶️',callback_data=Pagination(action='next', page=page, list_type=list_type).pack()),
